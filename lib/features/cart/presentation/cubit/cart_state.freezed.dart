...
mixin _$CartState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<CartEntity> cart) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<CartEntity> cart)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<CartEntity> cart}) : _cart = cart;
...
abstract class _Loaded implements CartState {
  const factory _Loaded({required final List<CartEntity> cart}) = _$LoadedImpl;
